...
const SorbetSensation = ({ theme = "light" }) => {
    ...
    return (
        ...
        >
            {/* Header */}
            <h1 className="text-2xl sm:text-3xl font-bold mb-8 text-center flex items-center justify-center gap-3">
                🌈 Sorbet Sensation Collection
            </h1>

            {/* No Products */}
            {products.length === 0 ? (
                <p className="text-center text-gray-500">
                    No Sorbet Sensation items found.
                </p>
            ) : (
                    ...
                    {products.map((item) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                style={{
                                    background:
                                        "linear-gradient(135deg, #FF6B9E 0%, #FECACA 100%)",
                                }}
                            >
